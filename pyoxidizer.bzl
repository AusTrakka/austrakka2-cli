...
def make_exe():
    ...
    policy.resources_location_fallback = "filesystem-relative:austrakka-lib"

    python_config = dist.make_python_interpreter_config()
    python_config.run_module = "austrakka"
    python_config.run_command = "from austrakka.main import main; main()"
    ...
    for resource in exe.pip_install([CWD]):
        resource.add_location = "filesystem-relative:austrakka-lib"
