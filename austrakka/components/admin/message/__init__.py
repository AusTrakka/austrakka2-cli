...
@table_format_option()
def message_metrics(queue_name: str, out_format: str):
    '''
    List metrics for queues
    '''
    metrics_message(queue_name, out_format)
...
def message_show(queue_name: str, msg_id: int, out_format: str):
    '''
    Show contents of a message
    '''
    show_message(queue_name, msg_id, out_format)


@message.command('list')
@opt_queue_name()
@object_format_option()
def message_list(queue_name: str, out_format: str):
    '''
    List messages for a queue
    '''
    list_message(queue_name, out_format)
