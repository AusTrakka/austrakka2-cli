...
def _get_default_headers(
    ...
    default_headers = {
        ...
        'Authorization': f'Bearer {AusTrakkaCtx.get_value(CxtKey.TOKEN)}',
...
def _get_url(path: str):
    return f'{AusTrakkaCtx.get_value(CxtKey.URI)}/api/{path}'
...
def _get_client(
    ...
    return httpx.Client(
        ...
        verify=not AusTrakkaCtx.get_value(CxtKey.SKIP_CERT_VERIFY),
        timeout=None,
        http2=AusTrakkaCtx.get_value(CxtKey.USE_HTTP2),
    )
