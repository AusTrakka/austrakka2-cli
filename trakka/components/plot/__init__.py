...
from trakka.components.plot.funcs import add_plot, update_plot, disable_plot, enable_plot, \
...
from trakka.utils.options import opt_abbrev, opt_plottype, opt_plotspec
